## ==========================
## build protocolbuffers/protobuf-go
...
RUN go get google.golang.org/protobuf/cmd/protoc-gen-go && \
    install -Ds ${GOPATH}/bin/protoc-gen-go /out/usr/bin/protoc-gen-gov2

## ==========================
## build protoc-gen-dart

## https://github.com/dart-lang/protobuf/tree/master/protoc_plugin

FROM google/dart as dart_builder

RUN git clone https://github.com/dart-lang/protobuf.git && \
    cd protobuf/protoc_plugin && pub install
RUN mkdir -p /out/usr/bin && \
    dart2native protobuf/protoc_plugin/bin/protoc_plugin.dart -o /out/usr/bin/protoc-gen-dart

## ==========================
## into thethingsindustries/protoc

## https://github.com/TheThingsIndustries/docker-protobuf
FROM thethingsindustries/protoc
